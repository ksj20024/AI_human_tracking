...
echo "=================================================================="
echo "가상환경 + 라이브러리 + MOT 데이터셋 통합 인프라 구축 개시"
echo "=================================================================="

# 1. 파이썬 가상환경 생성 및 활성화
echo "파이썬 독립 가상환경(.venv) 생성 및 활성화 중..."
python3 -m venv .venv
source .venv/bin/activate

# 2. pip 최신화 및 CUDA 12.8 PyTorch 설치
echo "CUDA 12.8 PyTorch 및 핵심 툴킷 설치 중..."
pip install --upgrade pip
pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu126 --force-reinstall

# 3. requirements.txt 기반 종속성 패키지 일괄 주입
if [ -f "requirements.txt" ]; then
    echo "requirements.txt 기반 의존성 패키지 일괄 설치 중..."
    pip install -r requirements.txt
else
    echo "⚠️ requirements.txt 파일이 보이지 않아 필수 패키지를 개별 설치합니다."
...
# 5. MOT17 백그라운드 다운로드 및 압축 해제 후 삭제
echo "MOT17 다운로드 및 배치 시작 ..."
...
echo "=================================================================="
echo "환경 세팅 및 데이터셋 배치 완료"
echo "다음 단계: 'python convert_mot_to_yolo.py'를 실행하세요."
echo "=================================================================="